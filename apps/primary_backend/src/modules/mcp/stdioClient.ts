...
class McpStdioSession {
    ...
    async discoverTools(): Promise<McpToolDescription[]> {
...
export class McpStdioClient {
    ...
    static async discoverTools(sessionKey: string, server: McpServerCommand): Promise<McpToolDescription[]> {
        return this.getSession(sessionKey, server).discoverTools();
    }
